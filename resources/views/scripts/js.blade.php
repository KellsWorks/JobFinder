    ...
    <script src="{{ asset('assets/plugins/counter-up/jquery.counterup.min.j') }}s"></script>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.14.0/webfonts/fa-solid-900.woff"></script>
